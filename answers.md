...
## Задание 94
### Вывести фамилии преподавателей, которые принимали экзамены более чем по одному предмету
```

```

## Задание 95
### Вывести название работ, в аннотации которых или в ключевых словах которых содержится слово "компетенции"
```
